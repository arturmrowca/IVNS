...
from config.specification_set import TeslaSpecPresets
from enums.sec_cfg_enum import HashMechEnum, AuKeyLengthEnum, PRF, \
    AsymAuthMechEnum, SymAuthMechEnum

#===============================================================================
#     Define preset
#===============================================================================

TeslaSpecPresets().setup_spec = [0, 999999, 10000] 
TeslaSpecPresets().mac_spec = [SymAuthMechEnum.AES, AuKeyLengthEnum.bit_128]
TeslaSpecPresets().prf_create_chain = PRF.DUMMY 
TeslaSpecPresets().prf_generate_mac_key = PRF.DUMMY 
TeslaSpecPresets().key_exchange_spec = [SymAuthMechEnum.AES, AuKeyLengthEnum.bit_128, SymAuthMechEnum.CBC, 100]  # also symmetric possible -> Masterkey
