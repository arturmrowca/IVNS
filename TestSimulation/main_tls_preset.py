...
from config.specification_set import TlsSpecPresets
from enums.tls_enums import CompressionMethod
from enums.sec_cfg_enum import HashMechEnum, AuKeyLengthEnum, AsymAuthMechEnum, \
    PRF, SymAuthMechEnum
...
TlsSpecPresets().server_certificate_spec = [AsymAuthMechEnum.RSA, AuKeyLengthEnum.bit_512, 3, HashMechEnum.MD5, 1, 1000]
TlsSpecPresets().client_certificate_spec = [AsymAuthMechEnum.RSA, AuKeyLengthEnum.bit_512, 3, HashMechEnum.MD5, 1, 1000]
...
TlsSpecPresets().apply_spec(ecu_spec)
